...
public class IQIYI extends Spider {
    ...
    private String m2938q(String str, String str2) {
        String str3;
        try {
            if (str2.startsWith("//")) {
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> hashMap) {
        ...
        try {
            ...
            String m2007h = OkHttp.string(str3, iqiyi.dn(str3));
            JSONObject jSONObject = new JSONObject();
            try {
                JSONArray optJSONArray = new JSONObject(m2007h).optJSONObject("data").optJSONArray("list");
                JSONArray jSONArray = new JSONArray();
                int i = 0;
                while (i < optJSONArray.length()) {
                    JSONObject optJSONObject = optJSONArray.optJSONObject(i);
                    String optString = optJSONObject.optString("name");
                    String m2938q = iqiyi.m2938q(str3, optJSONObject.optString("imageUrl"));
                    ...
                    if (!optJSONObject.optString("albumId").equals("")) {
                        optString3 = optJSONObject.optInt("sourceId") != 0 ? "/video/video/baseinfo/" + optJSONObject.optString("tvId") + "?userInfo=verify&jsonpCbName=videoInfo39" : "/albums/album/avlistinfo?aid=" + optJSONObject.optString("albumId") + "&size=5000&page=1&url=" + optString3;
                    ...
                    jSONObject2.put("vod_pic", m2938q);
    ...
    public String detailContent(List<String> list) {
        try {
            ...
            sb.append("https://pcw-api.iqiyi.com");
            sb.append(list.get(0));
            String sb2 = sb.toString();
            JSONObject jSONObject = new JSONObject(OkHttp.string(sb2, dn(sb2))).getJSONObject("data");
            JSONObject jSONObject2 = new JSONObject();
            ...
            jSONObject2.put("vod_pic", m2938q(sb2, optJSONObject.optString("imageUrl")));
    ...
    public String homeContent(boolean z) {
        ...
        try {
            ...
            String m2007h = OkHttp.string("https://pcw-api.iqiyi.com/search/video/videolists?channel_id=2&is_purchase=&mode=24&pageNum=1&pageSize=24&data_type=1&site=iqiyi", iqiyi.dn("https://pcw-api.iqiyi.com/search/video/videolists?channel_id=2&is_purchase=&mode=24&pageNum=1&pageSize=24&data_type=1&site=iqiyi"));
            JSONObject jSONObject = new JSONObject();
            ...
            try {
                ...
                while (i < optJSONArray.length()) {
                    JSONObject optJSONObject = optJSONArray.optJSONObject(i);
                    String optString = optJSONObject.optString("name");
                    String m2938q = iqiyi.m2938q(str, optJSONObject.optString("imageUrl"));
                    String optString2 = optJSONObject.optString("score");
                    String optString3 = optJSONObject.optString("playUrl");
                    String str2 = str;
                    if (!optJSONObject.optString("albumId").equals("")) {
    ...
    public String homeVideoContent() {
        try {
            JSONArray jSONArray = new JSONObject(OkHttp.string("https://pcw-api.iqiyi.com/api.php/app/index_video?token=", dn("https://pcw-api.iqiyi.com/api.php/app/index_video?token="))).getJSONArray("list");
    ...
    public String searchContent(String str, boolean z) {
        try {
            String str2 = "https://search.video.iqiyi.com/o?if=html5&key=" + str + "&pageNum=1&pos=1&pageSize=20";
            JSONArray optJSONArray = new JSONObject(OkHttp.string(str2, dn(str2))).optJSONObject("data").optJSONArray("docinfos");
            JSONArray jSONArray = new JSONArray();
            for (int i = 0; i < optJSONArray.length(); i++) {
                ...
                if (optJSONObject.optInt("album_type") == 0) {
                    jSONObject.put("vod_id", "/albums/album/avlistinfo?aid=" + optJSONObject.optString("qipu_id") + "&size=5000&page=1&url=" + optString);
                    jSONObject.put("vod_name", optJSONObject.optString("albumTitle"));
                    jSONObject.put("vod_pic", optJSONObject.optString("albumImg"));
                    jSONObject.put("vod_remarks", optJSONObject.optString("releaseDate"));
